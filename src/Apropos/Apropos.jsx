...
import TRAIN from "./ImgApropos/photoLinkedin.jpg";
import Pdf from "./ImgApropos/BEKRI-MEHDI-2021.pdf";
import AOS from "aos";
    ...
    <Container>
      <Row>
        ...
        <Col xs="12" sm="12" md="6" lg="6">
          <div
            className="section_title_two text-center"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            ...
            <P>
              {" "}
              Conducteur de train en depôt à la SNCF, j'ai toujours été attiré
            ...
            <P>
              J'ai par la suite engagé une demande de reconversion professionnel
              sur temps de travail et vais entamer en Mars 2021 une formation
              REACT/NODE à la WILD CODE SCOOL afin de parfaire mes connaissances
